...
//        todoListView.setItems(TodoData.getInstance().getTodoItems());
    ...
    // Code that handles File>New button press
    @FXML
...
//            todoListView.getItems().setAll(TodoData.getInstance().getTodoItems());
    ...
    public void showEditItemDialog(){
        ...
        try{
            ...
            System.out.println("Couldn't load edit menu");
            e.printStackTrace();
            return;

        }
        DialogController controller = fxmlLoader.getController();
        controller.populateCurrentItem(todoListView.getSelectionModel().getSelectedItem());
        ...
        if(result.isPresent() && result.get() == ButtonType.OK){
            ...
            controller.editItem(todoListView.getSelectionModel().getSelectedItem());
